...
createError, createLexicalError, createSyntaxError, createShortTitleError, 
// Error collector
ErrorCollector, 
// Error handling utilities
tryParse, tryParseAsync, combineResults, 
// Constants
ERROR_SEVERITY, ERROR_CATEGORIES, ERROR_CODES, 
// Global collector
...
function measurePerformance(testName, fn, maxDuration = 2.0) {
...
async function measurePerformanceAsync(testName, fn, maxDuration = 5.0) {
    const start = performance.now();
