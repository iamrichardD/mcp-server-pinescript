...
import { 
// Main API functions
analyzePineScript, quickValidateShortTitle, initializeParser, getParserStatus, createPineScriptParser, 
// Error classes
PineScriptParseError, PineScriptValidationError, 
// Type guards
isPineScriptParseError, isPineScriptValidationError, 
// Performance monitoring
PerformanceMonitor, performanceMonitor, 
// Re-exported functions (testing integration)
parseScript, extractFunctionParameters, validateShortTitle, } from '../../src/parser/index.js';
...
async function measurePerformanceAsync(testName, fn) {
    const start = performance.now();
    ...
    describe('measureAsync() method', () => {
        ...
        it('should handle async exceptions in <5ms', async () => {
            await measurePerformanceAsync('PerformanceMonitor async exception', async () => {
                await expect(monitor.measureAsync('error-async-op', async () => {
